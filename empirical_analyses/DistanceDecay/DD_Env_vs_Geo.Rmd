...
all.pca.dist <- vegdist(allscores, "euclidean")
sub.pca.dist <- vegdist(subscores, "euclidean")
```


```{r}
file <- paste("~/GitHub/DistDecay/figs/FromSites/Env_vs_Geo.png", sep="")
png(filename=file)
...
slope <- round(coefficients(pca_vs_geo)[2], 2)
rs <- round(summary(pca_vs_geo)$adj.r.squared, 2)
