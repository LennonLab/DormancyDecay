...
corr <- cor.test(env$TP, env$rna, method="pearson")
...
corr <- cor.test(env$TP, env$dna, method="pearson")
p <- round(corr$p.value,3)
c <- round(corr$estimate,2)
plot(env$TP, env$dna, ylab="DNA", xlab="TP", cex.lab=1.25,
     cex=1, cex.axis = 1, main=paste("r =", c, ", p =", p))
abline(lm(env$dna ~ env$TP))
...
corr <- cor.test(env$TP, env$N.tot, method="pearson")
p <- round(corr$p.value,3)
c <- round(corr$estimate,2)
plot(env$TP, env$N.tot, ylab="Total N", xlab="TP", cex.lab=1.25,
     cex=1, cex.axis = 1, main=paste("r =", c, ", p =", p))
abline(lm(env$N.tot ~ env$TP))

corr <- cor.test(env$TP, env$N.ded, method="pearson")
p <- round(corr$p.value,3)
c <- round(corr$estimate,2)
plot(env$TP, env$N.ded, ylab="Dead density", xlab="TP", cex.lab=1.25,
     cex=1, cex.axis = 1, main=paste("r =", c, ", p =", p))
abline(lm(env$N.ded ~ env$TP))
```
