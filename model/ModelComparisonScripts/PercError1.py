...
def figfunction():
    ...
    xlab = 'active death'
    fig = figplot(df['fit'], df['m-mean-Dice'], df['aded'], xlab, ylab, fig, 1)

    xlab = 'dormant death'
    fig = figplot(df['fit'], df['m-mean-Dice'], df['dded'], xlab, ylab, fig, 2)

    xlab = 'active random dispersal'
    fig = figplot(df['fit'], df['m-mean-Dice'], df['ad_r'], xlab, ylab, fig, 4)

    xlab = 'dormant random dispersal'
    fig = figplot(df['fit'], df['m-mean-Dice'], df['dd_r'], xlab, ylab, fig, 5)

    xlab = 'active spatial dispersal'
    fig = figplot(df['fit'], df['m-mean-Dice'], df['ad_s'], xlab, ylab, fig, 7)
    ...
    xlab = 'active death'
    fig = figplot(df['fit'], df['m-mean-Canb'], df['aded'], xlab, ylab, fig, 1)

    xlab = 'dormant death'
    fig = figplot(df['fit'], df['m-mean-Canb'], df['dded'], xlab, ylab, fig, 2)

    xlab = 'active random dispersal'
    fig = figplot(df['fit'], df['m-mean-Canb'], df['ad_r'], xlab, ylab, fig, 4)

    xlab = 'dormant random dispersal'
    fig = figplot(df['fit'], df['m-mean-Canb'], df['dd_r'], xlab, ylab, fig, 5)

    xlab = 'active spatial dispersal'
    fig = figplot(df['fit'], df['m-mean-Canb'], df['ad_s'], xlab, ylab, fig, 7)
